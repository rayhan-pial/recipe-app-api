...
def detail_url(ingredient_id):
    """Create and retun an ingredient detail URL """
    return reverse('recipe:ingredient-detail', args=[ingredient_id])


def create_user(email='user@example.com', password='passadasds12345'):
    """Create & return demo user"""
...
class PrivateIngredientsApiTest(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        """Test list of ingredients to liited authorized user"""
    ...
    def test_filtered_ingredients_unique(self):
        ...
        Ingredient.objects.create(user=self.user, name='lichu')
