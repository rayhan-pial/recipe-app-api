...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            'link': 'https://example.com/dishum.pdf',
    ...
    def test_update_user_returns_error(self):
        """Test changing user id from patching recipe"""
        new_user = create_user(email='User2@gmail.com', password='test52544')
        recipe = create_recipe(user=self.user)
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal('4.30'),
            'ingredients': [{'name': 'Caulilower'}, {'name': 'Salt'}]
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_create_ingredient_on_update(self):
        """Test creating an indgredient when updating a recipe"""
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Thai food')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='toast')
        r2 = create_recipe(user=self.user, title='Cacciatore')
        r3 = create_recipe(user=self.user, title='Lental')
